...
function Faker (opts) {
  ...
  var locale = self.locale || opts.locale || "en_IND";
  var localeFallback = self.localeFallback || opts.localeFallback || "en_IND";
  ...
  var Newspaper = require("./news_paper");
  self.newspaper = new Newspaper(self);
  ...
  var _definitions = {
    ...
    "news_paper": ["names", "officeLocs", "ceo", "foundedAt"],
    "title": "",
    "separator": ""
  };
